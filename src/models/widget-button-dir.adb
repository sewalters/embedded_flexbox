...
package body Widget.Button.Dir is
    ...
    procedure switch_dir (This : in out Instance) is
    begin

        if This.target.child_flex.dir = left_right then
            This.target.child_flex.dir := right_left;
        elsif This.target.child_flex.dir = right_left then
            This.target.child_flex.dir := top_bottom;
        elsif This.target.child_flex.dir = top_bottom then
            This.target.child_flex.dir := bottom_top;
        else
            This.target.child_flex.dir := left_right;
        end if;

    end switch_dir;

end Widget.Button.Dir;